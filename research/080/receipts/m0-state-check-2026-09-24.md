...
host, before M0b adds the custody path, the watchdog and B16–B18.
...
No experiment ran, and none may run until v4's design and analysis locks and M0b's B16–B18.
