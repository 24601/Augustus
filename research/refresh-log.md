...
- Docs + evaluator on a **fresh PR off main** (`cursor/hourly-0843-augustus-fold-220d`).
  ...
  items 273–288 / batch #96), #32 (`486e93e`, Release v0.4.0), and #33
  (README map). **HARD RULE:** do not reopen or amend PR
...
- Folded into `notes.md` §114, SKILL.md (description uniqueness + protocol triggers +
  ...
  docs/ecosystem, findings batch #96, sources.json. Hunches labeled. No wrapper.
