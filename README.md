...
- `.agents/skills/augustus/references/mixed-architecture.md` — default
  ...
  JA ModernBERT cross-encoder (argos1111/modernbert-ja-310m-jev; pair score → softmax → Choice/Score/Noul; format_version modernbert-jev/1; unofficial ≠ TypeSafe Jev; ≠ kunchenguid/local-jev);
...
- `.agents/skills/augustus/references/applied-mappings.md` — context sieve,
  ...
  SIGNAL jevcache/jev-align + JA ModernBERT (`notes.md` §93; fingerprint after redact; recall vs decide; publish fingerprints+answers; CI replay as Harbor cousin; Cache hit ≠ correctness; hyperspaceai/jevcache ≠ kushals256/jevcache; human labels only; score never auto-accepts; production capture flywheel; sutro-sh/jev-align ≠ caiovicentino/jev-align; JA ModernBERT cross-encoder; pair score → softmax → Choice/Score/Noul; format_version modernbert-jev/1; unofficial ≠ TypeSafe Jev; JA datasets converted to System One; honest vs dedicated-head cards; cross-encoder as System One backend; argos1111/modernbert-ja-310m-jev ≠ kunchenguid/local-jev; memoize typed decisions; VOI of cache hit; GEPA + System One; Soft Noul ≠ hard safety)
...
- `.agents/skills/augustus/references/validation.md` — design gate, eval
  ...
  *theirs*;
  ...
  SIGNAL jevcache/jev-align + JA ModernBERT (`notes.md` §93; Cache hit ≠ correctness; score never auto-accepts; unofficial ≠ TypeSafe Jev; hyperspaceai/jevcache ≠ kushals256/jevcache; sutro-sh/jev-align ≠ caiovicentino/jev-align; argos1111/modernbert-ja-310m-jev ≠ kunchenguid/local-jev; JNLI 92.62% / JComQA 92.40% *theirs*; n=16 not statistical))
