...
- `.agents/skills/augustus/references/validation.md` — design gate, eval
  ...
  *theirs*;
  ...
  hourly 0345 (`notes.md` §108; size **0** WITH CONTENTS injection-bench/dspy-bench/abstentionbench/pdf-race/jev-atlas/flopcheck; license **null** jev-atlas/jev-is-here; HF verdict twin likes **5** ≠ GH **107★**; Hub family cards still do not ship weights; WANLI-256 74.6% / 65.2% / 71.1% *theirs*; Bonsai 1 27B Q1_0 runs on stock llama.cpp; ternary still needs PrismML fork; CLEVR-4 held-out joint 0%; 294,912 derived targets not independent samples; 63/63 selected answers / 5.1e-4 CPU / 1.2e-2 WebGPU; UpHash-Network/mini-jev is yuki-oshio transfer; Jev best ranking / Haiku better ECE 0.021 vs 0.058; 0.5–0.9 band is where Jev's numbers do not mean what they say; Prompt wording moves panic 28%; Jev agreement is similarity, never ground truth; AbstentionBench-on-Jev rank 1 of 20 vs 2025 field; question-asymmetry; forward-looking 0.465 never extreme; select_threshold returns inf; parser owns the wall clock; 12/12 tie is a tie; titles selected not generated; T never changes argmax; confidence ≠ top-label p; 40–48 rows too small to ship T; SemIf **2128★** vs §107 **2094**; jevlike **1026★**; TypeAR **12★** flat; AnotiaWang **94★**; tracker likes **60** lastModified UNCHANGED; Hub Laya likes **765**; do not reopen or amend PR #23 or #24 or #25)),
