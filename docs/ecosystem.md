...
- **@mervenoyann parent** — [status/2101463303734067592](https://x.com/mervenoyann/status/2101463303734067592) created 2026-09-20T00:07:49Z. people who compare Jev against GPT-5.6 has never fine-tuned BERTForXYZ for living and it shows. zero shot classifiers. scale them as much as decoder only models. many problems solved with LLMs could have been solved with them, it was a skill issue. This pass: likes **415** / impressions **34844** / RTs 22 / bookmarks 89. Quotes Maziyar. **≠** Akshay §85 **≠** aahf 64× §110.
- **@mervenoyann follow-up** — [status/2101592535835529527](https://x.com/mervenoyann/status/2101592535835529527) created 2026-09-20T08:41:20Z. opt for DeBERTa and ModernBERT ones. Hub pointers (trending ZS; task page; multimodal image<>text). This pass: likes **179** / impressions **9238** / RTs 21 / bookmarks 132. hf:MoritzLaurer/deberta-v3-large-zeroshot-v2.0 likes **139**; hf:MoritzLaurer/ModernBERT-large-zeroshot-v2.0 likes **72**. bart-large-mnli likes 1616 is the widget default, **not** her pick. softmax/ZS scores still ≠ calibrated Noul. Do not copy `pipeline()`.

Pulse (do not invent): X MCP used ~2026-09-20T14:10Z. Author @mervenoyann (merve; 92,246 followers). Archer still promised_not_landed. do not reopen or amend PR #23/#24/#25/#26/#27/#28/#29. `invented_signal: false`.
