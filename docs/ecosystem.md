...
- **siren2345/jev-single-decode** — Python MIT; **0★**; HEAD `fda74a09`; README SHA `33d755d6`; LICENSE SHA `3551844d`; size **432**. prefill plus exactly one decode. softmax over A/B/C ≠ Noul. BBQ 9,053/10,000 (90.53%). ECE 0.0890. Mean confidence 0.9943. overconfident. score and noul not implemented.
...
Pulse (do not invent): Archer still NOT landed. Hub `archerhume/4rcherhume` HTTP **401** — not re-fetched as a rewrite. Tracker `multimodalart/jev-reproductions-tracker` likes **64** **flat**; lastModified `2026-09-20T04:29:16.000Z` **UNCHANGED**. tracker likes 64 flat, lastModified UNCHANGED. Live REST: SemIf **2206★** (+20 vs §110 **2186**); jevlike **1042★** (+4 vs §110 **1038**); TypeAR-AI/TypeAR **14★** **flat**. AnotiaWang/awesome-jev **97★** (+1 vs §110 **96**) ≠ yibie/awesome-jev **503★** (+13 vs §110 **490**). Hub Laya likes **817**. Laya likes 817 (was 802). Blackwood tracker ABSENT. Archer still promised_not_landed. Qwen3.8-27B ≠ Archer. X MCP not used this hour; no invented tweets. do not reopen or amend PR #23/#24/#25/#26/#27/#28. `invented_signal: false`.
