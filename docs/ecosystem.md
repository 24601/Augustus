...
- **JulesHuisman/jev-eval** — Python; license **null**; **0★**; HEAD `15cf3b83`; README SHA `e69de29b` **empty**; size **0** WITH CONTENTS. JulesHuisman/jev-eval scaffolding / empty README SHA e69de29b. JulesHuisman/jev-eval ≠ SivletLabs/jev-eval ≠ willkelly/jev-evaluation ≠ 4esv ≠ xxkuboxx ≠ onlyoneaman ≠ dayhaysoos/jevals. Thin / still a real card.
- **AHTOOOXA/jev-cyrillic-audit** — Python MIT; **0★**; HEAD `7167894a`; README SHA `d36a36f5`; LICENSE SHA `f9b9193e`; size **0** WITH CONTENTS. PRIMARY. XNLI EN 88.3% ECE 0.032 → RU 77.3% ECE 0.096. Δ −11.0 pp [−14.2,−7.8]; ECE +0.063. MASSIVE no detectable difference at n=600. confidence is function of p_max (r=1.000). Pre-registration is the exact envelope; Jev is SENSOR.
...
- **LiuHao-1443/jev-table-tennis** — Python MIT; **1★**; HEAD `2c80dec3`; README SHA `fe5d0c37`; LICENSE SHA `777dc3d6`; size **0** WITH CONTENTS. 7 bands 6/10 vs 40 bands 0/10. Physics/collisions/scoring local; Jev SENSOR on band choice.
...
- **hemanth/hfjev** — Python MIT; **1★**; HEAD `6f2aa501`; README SHA `20651a25`; LICENSE SHA `0ac06d77`; size **0** WITH CONTENTS. classify HF datasets across typed semantic dimensions. **no numbers**.
- **akash-kamat/jev-llm** — JavaScript; README ISC / GitHub license **null**; **0★**; HEAD `b7d0b04c`; README SHA `c42907a6`; size **54**. pointer-not-generator 400 human-authored responses. Bank of replies is exact; Jev SENSOR on which reply.
- **chenmingtang830/jevgraph** — Python Apache-2.0; **0★**; HEAD `85cebe00`; README SHA `e57a7b97`; LICENSE SHA `57bc88a1`; size **125**. proposed ≠ authorized. FewRel 160: Jev 85.0% vs lexical 13.125%. gated 100% (95/95) coverage 59.375%. Graph write is exact authorization; Jev SENSOR on typed relation.
- **Towow-ai/jpp** — Python MIT; **2★**; HEAD `18e8a2d7`; README SHA `0a82d97f`; LICENSE SHA `b1a46fbc`; size **241**. J++ composable semantic computation language. ≠ Microsoft Visual J++ ≠ southpolesteve/probably.
- **whyashthakker/awesome-jev-use-cases** — HTML MIT; **3★**; HEAD `96dfcb30`; README SHA `6b4fcff4`; LICENSE SHA `13b5a2a6`; size **426**. No benchmark winner claimed. Catalog ≠ endorsement. ≠ walidboulanouar/awesome-jev-use-cases.
...
- **shinshin86/jev-aituber-tension-sample** — TypeScript MIT; **0★**; HEAD `8c0a8ffb`; README SHA `06536d19`; LICENSE SHA `8b20d89e`; size **94**. AITuber tension ±15. Thin demo; still a real card.
