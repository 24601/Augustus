...
- **kushalpatil/jevify-gemma4-26b-a4b** — HF license **gemma**; likes **0**; sha `d4c0d1d4`; lastModified 2026-09-20T10:26:23Z. Gemma-4 26B-A4B jevify classification+calibration. Hub jevify merged LoRA **ships weights**. PAWS 0.580/ece 0.288 is the weak cell. kushalpatil/jevify-gemma4 ≠ Mintzs/jevify ≠ gulagala001/jevify ≠ uspraveen/Jevify. GH kushalpatil07/jevify **404**. n=307 OOD ECE 0.061 is not a hard gate of “honest probabilities.”
...
- **roadius2/ultra_laya** — Python Apache-2.0; **0★**; HEAD `0dff5bd2`; README SHA `da95bc05`; LICENSE SHA `d9a10c0d`; size **0** WITH CONTENTS; default branch **`claude/laya-jev-review-gg5ppo`**. roadus2 watch misspelling; lock roadius2/ultra_laya. ultra_laya REVIEW defects. Do **not** paste vs-Jev table as this-fork win.
...
Pulse (do not invent): Archer still NOT landed. Hub `archerhume/4rcherhume` HTTP **401** — not re-fetched as a rewrite. Tracker `multimodalart/jev-reproductions-tracker` likes **64** (+4 vs §108 **60**); lastModified `2026-09-20T04:29:16.000Z` **UNCHANGED**. Live REST: SemIf **2153★** (+25 vs §108 **2128**); jevlike **1030★** (+4 vs §108 **1026**); TypeAR-AI/TypeAR **13★** (+1 vs §108 **12**). AnotiaWang/awesome-jev **95★** (+1 vs §108 **94**) ≠ Awesomejev 656 entries / 38,160 stars (was 561/27007). Hub Laya likes **776**. Blackwood Hub HTTP 200 likes **2** **ABSENT** from tracker ITEMS. Qwen3.8-27B ≠ Archer. X MCP not used this hour; no invented tweets. `invented_signal: false`.
