...
- **elyashium/atlas-replay-lab** — JavaScript; GitHub license **null**; **0★**; HEAD `e0a10603`; empty README; size **197**. rule-based by default, optionally Jev-backed. missing key cannot break the experience.
- **siren2345/jev-single-decode** — Python MIT; **0★**; HEAD `be5ed87a`; README SHA `0c7bfbe8`; LICENSE SHA `3551844d`; size **0** WITH CONTENTS. prefill plus exactly one decode. softmax over A/B/C ≠ Noul. BBQ 9,053/10,000 (90.53%). ECE 0.0890. Mean confidence 0.9943. overconfident. score and noul not implemented.
...
- **IslamBaraka90/jev-typesafe-real-financial-use-cases** — JavaScript MIT; **0★**; HEAD `be357aad`; README SHA `5329b92e`; LICENSE SHA `caaa17a8`; size **6168**. Fifty recorded demos. Recorded ≠ alpha. Do **not** dump scoreboard.json.
...
- **Pleo2/awesome-jev-agent-skills** — Python MIT; **0★**; HEAD `42e3d179`; README SHA `efbe7ccf`; LICENSE SHA `25d9aa30`; size **0** WITH CONTENTS. Jev evaluations are advisory. catalog ≠ endorsement.
- **YehuiTang0316/jev-nlgrep** — TypeScript MIT; **1★**; HEAD `ceec0d92`; README SHA `49e98f18`; LICENSE SHA `17cdbc7e`; size **0** WITH CONTENTS. YehuiTang0316/jev-nlgrep ≠ Bentlybro/jevgrep ≠ can1357/jegrep ≠ uehaj/jev-semgrep. default threshold 0.8 still soft. 40-line windows cannot prove whole function.
- **dangquan1402/jev-extract** — Python MIT; **0★**; HEAD `8ab35925`; README SHA `9561e53d`; LICENSE SHA `d66f9c7a`; size **0** WITH CONTENTS. token-native sequential start/end Choice. Gemini/Haiku stubs not configured yet.
...
- **laguagu/jev-skills** — MIT LICENSE SHA `e5ede121`; **0★**; HEAD `871ec586`; README SHA `a315944d`; size **36**. laguagu/jev-skills ≠ laguagu/jev-evidence-lab ≠ Pleo2/awesome-jev-agent-skills.
- **lorensation/llm-cost-optimizer-jev** — Python Apache-2.0; **0★**; HEAD `ff3fc054`; README SHA `6f2a595a`; LICENSE SHA `261eeb9e`; size **227**. contract_passed is not a claim of guaranteed factual truth. Wilson lower bound 0.85 floor. fixture mode no savings claim.

Pulse (do not invent): Archer still NOT landed. Hub `archerhume/4rcherhume` HTTP **401** — not re-fetched as a rewrite. Tracker `multimodalart/jev-reproductions-tracker` likes **64** **flat**; lastModified `2026-09-20T04:29:16.000Z` **UNCHANGED**. tracker likes 64 flat, lastModified UNCHANGED. Live REST: SemIf **2198★** (+12 vs §110 **2186**); jevlike **1039★** (+1 vs §110 **1038**); TypeAR-AI/TypeAR **14★** **flat**. AnotiaWang/awesome-jev **96★** **flat** ≠ yibie/awesome-jev **498★** (+8 vs §110 **490**). Hub Laya likes **811**. Laya likes 811 (was 802). Blackwood tracker ABSENT. Archer still promised_not_landed. Qwen3.8-27B ≠ Archer. X MCP not used this hour; no invented tweets. do not reopen or amend PR #23/#24/#25/#26/#27/#28. `invented_signal: false`.
