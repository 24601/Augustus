...
- **Heman10x-NGU/Verdict-open-jev** — Python; SPDX NOASSERTION; **33★**; HEAD `465d542f`; README SHA `e2932455`; LICENSE SHA `84d35485`; size **6709**. Heman10x-NGU/Verdict-open-jev ≠ Heman10x-NGU/openJev-verdict-2.0. TF-IDF + LogReg ECE 0.0207 vs Jev 0.1440. Verdict-open-jev 48.07% vs Jev 90.80%. abstention combined recall 10.00%. p50 35.58 ms. K=25 (maximum capacity) 72.00%. 0.85 coverage 84.60% selective risk 1.18%.
...
- **erayyilmmaz/jev-decisionops** — **0★**; HEAD `fe4e7aff`; README SHA `4688009e`; size **67**. ACT / REVIEW / FALLBACK. A provider failure, timeout, malformed output, or missing answer is **not** a policy outcome. confidence is descriptive provider output, not a substitute for probability. Quality denominators include only valid scored answers. an exact halfway tie chooses the lower level.
...
Pulse (do not invent): Archer still NOT landed. Hub `archerhume/4rcherhume` HTTP **401** — not re-fetched as a rewrite. Tracker `multimodalart/jev-reproductions-tracker` likes **66** (+2 vs 64); lastModified `2026-09-20T04:29:16.000Z` **UNCHANGED**. Live REST: SemIf **2225★** (+18 vs §111 **2207**); jevlike **1046★** (+3 vs §111 **1043**); TypeAR-AI/TypeAR **301** → TypeLLM/TypeLLM **16★**. AnotiaWang/awesome-jev **98★** (+1 vs §111 **97**) ≠ yibie/awesome-jev **516★** (+10 vs §111 **506**). Hub Laya likes **852**. Laya likes 852 (was 822). Blackwood tracker ABSENT. Archer still promised_not_landed. Qwen3.8-27B ≠ Archer. X MCP not used this hour; no invented tweets. do not reopen or amend PR #23/#24/#25/#26/#27/#28/#29/#30. `invented_signal: false`.
