...
| Decision ledger / memoization | Fingerprint after redact; recall vs decide; share fingerprints+answers; CI replay | fingerprint after redact; recall vs decide; publish fingerprints+answers; CI replay as Harbor cousin; Cache hit ≠ correctness; hyperspaceai/jevcache ≠ kushals256/jevcache | [jevcache](https://github.com/hyperspaceai/jevcache) (license **null**; **8★** this pass, SIGNAL ★6; README SHA `7c2abe99`; HEAD `a211d13`). Not KV attention cache. Do not copy the installer curl. `notes.md` §93 |
| GEPA alignment loop | Human labels only; score never auto-accepts; production capture | human labels only; score never auto-accepts; production capture flywheel; sutro-sh/jev-align ≠ caiovicentino/jev-align | [jev-align](https://github.com/sutro-sh/jev-align) (Apache-2.0; **60★** this pass, SIGNAL ★56; forks **7**; README SHA `363fccb7`; HEAD `49753df`). Do not copy `uv` / keys. `notes.md` §93 |
