...
| Collapse hari007sh/jev into dannote/jev / quote T-fit 0.9 as Harbor τ | **Fail closed** (namesake; teacher is generate.py) | hari007sh/jev ≠ dannote/jev. Local cross-encoder. License null |
...
| Treat pi-jev-gate as fail-closed / restore the ask band | **Fail closed** (polarity; binary) | pi-jev-gate fail-open binary p(block)≥0.50. Ask band removed. **≠** pi-jev-approver |
...
| Soft-score vs hard-argmax | Read p; mid-band is refusal; binary fail-open | typed-gate band [0.40,0.60] is refusal; pi-jev-gate fail-open binary p(block)≥0.50 | [harshpuri84/typed-gate](https://github.com/harshpuri84/typed-gate) + [fivethirty/pi-jev-gate](https://github.com/fivethirty/pi-jev-gate) (MIT; **0★**; size 0). rh-guard owns the gate cousin. `notes.md` §91 |
