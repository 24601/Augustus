...
| Treat JA ModernBERT softmax as TypeSafe Noul / skip format_version modernbert-jev/1 | **Fail closed** (unofficial ≠ calibrated TypeSafe) | unofficial ≠ TypeSafe Jev. format_version modernbert-jev/1. pair score → softmax → Choice/Score/Noul. Soft Noul ≠ hard safety. `notes.md` §93 |
| Collapse argos1111/modernbert-ja-310m-jev into kunchenguid/local-jev / paste dedicated-head JNLI as this card | **Fail closed** (namesake + honest card) | argos1111/modernbert-ja-310m-jev ≠ kunchenguid/local-jev. honest vs dedicated-head cards. JA datasets converted to System One. `notes.md` §93 |
...
| JA ModernBERT cross-encoder | Pair score → softmax → Choice/Score/Noul; format lock | JA ModernBERT cross-encoder; pair score → softmax → Choice/Score/Noul; format_version modernbert-jev/1; unofficial ≠ TypeSafe Jev; JA datasets converted to System One; honest vs dedicated-head cards; cross-encoder as System One backend; argos1111/modernbert-ja-310m-jev ≠ kunchenguid/local-jev | [argos1111/modernbert-ja-310m-jev](https://huggingface.co/argos1111/modernbert-ja-310m-jev) (CC-BY-SA-4.0; **2 likes**; sha `07cda235`) via [Argos1111/jev_local](https://github.com/Argos1111/jev_local) (**14★**; license **null**). JNLI 92.62% / JComQA 92.40% *theirs*. Do not copy setup scripts. `notes.md` §93 |
