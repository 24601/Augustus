...
| Paste groundedness Macro-F1 as “Jev wins quality” / collapse into jev-judge-bench | **Fail closed** (axis; namesake) | groundedness-judge-bench native vs schema-guided. Fastest/cheapest ≠ quality. implicit_true still unsupported. **≠** jev-judge-bench |
...
| Native vs schema-guided Harbor | RAGTruth groundedness; native Noul vs LLM JSON | Fastest/cheapest ≠ quality; implicit_true still unsupported | [groundedness-judge-bench](https://github.com/slavadubrov/groundedness-judge-bench) (LICENSE MIT / SPDX NOASSERTION; **0★**; README SHA `5cc070d8`). **≠** jev-judge-bench. `notes.md` §90 |
