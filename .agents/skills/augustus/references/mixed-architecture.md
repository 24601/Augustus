...
| Treat unofficial JA ModernBERT as TypeSafe / collapse Argos1111/jev_local into us/jev-local | **Fail closed** (unofficial ≠ TypeSafe) | unofficial ≠ TypeSafe; format_version modernbert-jev/1; Argos1111/jev_local ≠ us/jev-local ≠ kunchenguid/local-jev. `notes.md` §94 |
...
| Compile-time System One / questions-as-index | Jev shapes the DSL at compile; runtime is catalyst handles | guidance ≠ hook; catalysts ≠ summaries; compile-time System One | [byenzyme/enzyme](https://github.com/byenzyme/enzyme) (license **null**; **63★** this pass, SIGNAL ★62; README SHA `9af7c570`; HEAD `c91d6b5`). ~350×/1000× *theirs*. Do not copy `curl \| bash`. `notes.md` §94 |
| Unofficial JA ModernBERT cross-encoder | Pair score → softmax Choice/Score/Noul; format lock | unofficial ≠ TypeSafe; format_version modernbert-jev/1; Argos1111/jev_local ≠ us/jev-local ≠ kunchenguid/local-jev | [argos1111/modernbert-ja-310m-jev](https://huggingface.co/argos1111/modernbert-ja-310m-jev) (CC-BY-SA-4.0; **2 likes**; sha `07cda235`) + [Argos1111/jev_local](https://github.com/Argos1111/jev_local) (**14★**; README SHA `ee7b536a`). JGLUE JNLI 92.62% / JComQA 92.40% *theirs*. `notes.md` §94 |
| NAR legitimacy / multimodal / Router-OOD | Institutional DiffusionGemma-as-Jev; native image Choice; script-before-p | Nemotron ≠ TypeSafe Jev; not a calibrated replacement; djev-dev complements djev-spark; images as Choice options; Laya essay numbers *theirs*; Router/OOD confidence | [Nemotron_Jev](https://github.com/pst2154/Nemotron_Jev) (**6★**; README SHA `f2f3d052`) + [djev-dev](https://github.com/Davipar/djev-dev) (Apache-2.0; **2★**; README SHA `6d59d020`) + [Laya essay](https://laya.convaiinnovations.com/). Gemma ~0.2s *theirs*. Do not re-paste vs-Jev. `notes.md` §94 |
