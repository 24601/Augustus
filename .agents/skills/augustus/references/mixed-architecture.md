...
| Treat kev OOD 0.76 as Jev-equivalent / isolation 4e-6 as identity / `/v1/systemone` wire as a Noul | **Fail closed** (replica honesty) | Archer-arch fidelity. kev family OOD 0.76–0.77 vs Jev 0.86. block-causal isolation. pointer/readout CE-trained. /v1/systemone drop-in. replica honesty. Do not rewrite §45. `notes.md` §98 |
