...
| Decision-as-plugin for SWE | Next-act Choice; overlay records model/depth; keep is a win | difficulty + policy thresholds + JSONL trace; jev-codex-pilot model + reasoning depth; keep/shadow/hybrid/reject | [jev-orchestrator](https://github.com/petercr/jev-orchestrator) (MIT; **0★**; README SHA `042c102e`) + [jev-codex-pilot](https://github.com/Charlyhno-eng/jev-codex-pilot) (MIT; **0★**; README SHA `6210d1e7`; size 1) + [jev-replacement](https://github.com/SunnyKikiHK/jev-replacement) (license null; **0★**; README SHA `3988319e`). Description ≠ live Choice. 20-case failed cost *theirs*. `notes.md` §93 |
| Evidence projection | Fetch to disk; Jev scores line ranges | quarry evidence projection | [quarry](https://github.com/jackboykin/quarry) (Go MIT; **0★**; README SHA `48e119fd`; size 0; **master**). Pointer, never paraphrase. 5 s fail-open. **≠** savka777/jev-search. `notes.md` §93 |
| Soft judgment integrity | Escape + calibrator + cache; CI shadow | jevguard calibrator/cache/escape; jev-ci-selector CI shadow mode | [jevguard](https://github.com/seb4ez/jevguard) (MIT; **0★**) + [jev-ci-selector](https://github.com/guilhem/jev-ci-selector) (license null; **0★**; size 432). **≠** jevcache. Shadow default. rh-guard owns. `notes.md` §93 |
| Physical/control first-class | Text-state robotics/3D atlas | Frank-ZY-Dou/awesome-jev robotics/3D/control | [awesome-jev](https://github.com/Frank-ZY-Dou/awesome-jev) (license null; **0★**; README SHA `c4825b7f`). Physical 2 / sim 8 / 3D 4 / vehicles-sim 4. One seed-0 ≠ a rate. **≠** awesome-jev-use-cases. `notes.md` §93 |
| Harbor-jevals / injection-firewall | Six-arm demo; no published ASR/FPR | one-dollar-tahoe TypeSafe Jev defense eval | [one-dollar-tahoe](https://github.com/PavitarSinghArneja/one-dollar-tahoe) (MIT; **0★**; README SHA `84bf6bd2`). ~74 demo. Do not copy attacks. rh-guard owns. `notes.md` §93 |
| llama.cpp replica | Numbered-choice softmax ≠ Noul | llama-jev llama.cpp replica | [llama-jev](https://github.com/webNeat/llama-jev) (license null; **0★**; README SHA `5ec204af`). 80 ms cold / 40 ms cache *theirs*. **≠** TypeSafe **≠** pcdServer. `notes.md` §93 |
