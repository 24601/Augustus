...
| Treat jev-kit exit 0 as claim truth / curl\|sh as a skill / matching quote as a proof | **Fail closed** (evidence ≠ authority) | source-bound evidence checks. local quote mismatch needs no API. exit 0 ≠ claim truth. WaynezProg/jev-kit ≠ jev-use ≠ jev-mcp. `notes.md` §102 |
...
| Source-bound evidence kit | Four tools; nine hosts; local quote match needs no API | Exit 0 ≠ claim truth; not jev-use / jev-mcp | [WaynezProg/jev-kit](https://github.com/WaynezProg/jev-kit) (MIT; **0★**; HEAD `4558554f`; README SHA `a7f14838`). source-bound evidence checks. local quote mismatch needs no API. exit 0 ≠ claim truth. WaynezProg/jev-kit ≠ jev-use ≠ jev-mcp. `notes.md` §102 |
