...
**0★**; HEAD `c0df647c`; README SHA `eb47c118`; size **0** WITH CONTENTS. `notes.md` §112.
...
BBQ 9,053/10,000 (90.53%). ECE 0.0890. Mean confidence 0.9943. overconfident.
score and noul not implemented. `notes.md` §112.
...
0.85 coverage 84.60% selective risk 1.18%. `notes.md` §112.
...
grpo_rlcr 0.78 / ECE 0.084. reliability 0.007 but resolution 0.000. `notes.md` §112.
...
E2 recomputes from saved probabilities. `notes.md` §112.
