...
| Upgrade-radar authored cases (not Harbor) | [GaneshVG18/upgrade-radar](https://github.com/GaneshVG18/upgrade-radar) | TypeScript MIT; **0★**; README SHA `b7603c01`. evidence-linked dependency upgrade. Jev never generates filenames. no_direct_evidence ≠ safe to merge. 48 authored cases *theirs*; live Jev private. `notes.md` §105 |
