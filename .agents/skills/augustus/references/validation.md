...
| AbstentionBench-on-Jev (question-asymmetry) | [sshariqali/jev-abstentionbench](https://github.com/sshariqali/jev-abstentionbench) | Python; README MIT / SPDX NOASSERTION; **0★**; HEAD `47a4ca0f`. rank 1 of 20 vs 2025 field. question-asymmetry. forward-looking 0.465 never extreme. `notes.md` §108 |
| openkev calibration layer (not a runtime) | [misakaikato/openkev](https://github.com/misakaikato/openkev) | Python MIT; **0★**; HEAD `864a2207`; README SHA `974d97f9`. ECE vs coverage independent. select_threshold returns inf. escalation catches uncertainty not ignorance. ≠ jaredpalmer/kev. `notes.md` §108 |
