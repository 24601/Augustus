...
| JulesHuisman scaffolding (not a board) | [JulesHuisman/jev-eval](https://github.com/JulesHuisman/jev-eval) | Python; license null; **0★**; HEAD `15cf3b83`; README SHA `e69de29b`; size **0** WITH CONTENTS. JulesHuisman/jev-eval scaffolding / empty README SHA e69de29b. `notes.md` §109 |
| Table-tennis band resolution | [LiuHao-1443/jev-table-tennis](https://github.com/LiuHao-1443/jev-table-tennis) | Python MIT; **1★**; HEAD `2c80dec3`. 7 bands 6/10 vs 40 bands 0/10. `notes.md` §109 |
...
| FewRel gated coverage (not production) | [chenmingtang830/jevgraph](https://github.com/chenmingtang830/jevgraph) | Python Apache-2.0; **0★**; HEAD `85cebe00`. FewRel 160: Jev 85.0% vs lexical 13.125%. gated 100% (95/95) coverage 59.375%. proposed ≠ authorized. `notes.md` §109 |
...
| Paper trader honest negative | [waterme7on/jev-paper-trader](https://github.com/waterme7on/jev-paper-trader) | JS; license null; **0★**; HEAD `ed98ca8e`. 90d trend +12.40% vs random +12.75% vs BH +41.71%. 5m win rate 25%. `notes.md` §109 |
