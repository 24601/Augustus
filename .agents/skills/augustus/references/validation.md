...
| Native vs schema-guided Harbor (RAGTruth) | [groundedness-judge-bench](https://github.com/slavadubrov/groundedness-judge-bench) | LICENSE MIT / SPDX NOASSERTION; **0★**; README SHA `5cc070d8`. 900/150; 3,600 req / 23.4 min / ~$0.3611 *theirs*. Jev Macro-F1 **0.6667** p50 **0.330s** $0.0369/1k; GLM **0.7661** (5 format fails). Fastest/cheapest ≠ quality. groundedness-judge-bench native vs schema-guided. implicit_true still unsupported. **≠** jev-judge-bench. `notes.md` §90 |
