...
| Mímir LFM (3-way NLI ≠ Noul) | [impacte/mimir-lfm-openjev](https://huggingface.co/impacte/mimir-lfm-openjev) | likes **0**; sha `2b999b3a`. WANLI 0.741 vs openjev v2 0.77 *theirs*. 3-way NLI ≠ Noul. `notes.md` §110 |
...
| jev-bench ranking ≠ calibration (PRIMARY) | [Running-Dolphins/jev-bench](https://github.com/Running-Dolphins/jev-bench) | Python MIT; **0★**; HEAD `67d2ee42`; size **0** WITH CONTENTS. “0.9 is not one number”. ranking ≠ calibration. banking77 0.8–0.9 stated 0.86 actual 0.73 over-confident *theirs*. ≠ Praveenrajus/jev-bench ≠ fstandhartinger/jevbench. `notes.md` §110 |
...
| decision-lab 8/8 not lift | [RadRebelSam/jev-decision-lab](https://github.com/RadRebelSam/jev-decision-lab) | TS MIT; **0★**; HEAD `e6d6d42d`; size **0** WITH CONTENTS. Function-only 5/8 vs hybrid 8/8. 4/8 without Jev. 8 designed cases not conversion lift. `notes.md` §110 |
| BigQuery 200-row (not a ranking) | [jackojacko05/compare-jev-bigquery-ai-functions](https://github.com/jackojacko05/compare-jev-bigquery-ai-functions) | Jupyter MIT; **0★**; HEAD `fca3771a`; size **0** WITH CONTENTS. 200-row pilot Jev 85.5% 171/200 vs Gemini Flash-Lite 86.0% 172/200 vs Pro 88.5% 177/200 *theirs*. not a ranking. `notes.md` §110 |
| joshhu 情緒測謊器 | [joshhu/jevtest](https://github.com/joshhu/jevtest) | HTML; license null; **0★**; HEAD `6a4df41d`; size **0** WITH CONTENTS. 1q 396ms / 30q 567ms. ±0.03. 33q $0.000045 vs Gemini ~5× slower ~60× cost *theirs*. ≠ realZachi/jevtest. `notes.md` §110 |
...
| jev-lsp pattern exact | [makefunstuff/jev-lsp](https://github.com/makefunstuff/jev-lsp) | Rust MIT; **0★**; HEAD `734c0f59`. pattern exact, judgement must clear floor. no matching pattern → no model call. not a correctness oracle. $0.00022 vs chat $0.00306 *theirs*. `notes.md` §110 |
