...
| JA ModernBERT cross-encoder (unofficial; not TypeSafe) | [argos1111/modernbert-ja-310m-jev](https://huggingface.co/argos1111/modernbert-ja-310m-jev) | CC-BY-SA-4.0; **2 likes**; sha `07cda235`. JA ModernBERT cross-encoder. pair score → softmax → Choice/Score/Noul. format_version modernbert-jev/1. unofficial ≠ TypeSafe Jev. JA datasets converted to System One. honest vs dedicated-head cards: JNLI **92.62%** (2323/2508) / JComQA **92.40%** (1033/1118) *theirs* vs LFM 17.15%/68.87%; dedicated-head card 92.93/93.53 is a different setup. Val 3k jnli 94.3% / jcommonsenseqa 95.9% / jsts exact 60.7% / massive-scenario 18-way 86.1% *theirs*. JMMLU error max_prob 0.66 *theirs*. n=16 not statistical. argos1111/modernbert-ja-310m-jev ≠ kunchenguid/local-jev. `notes.md` §93 |
