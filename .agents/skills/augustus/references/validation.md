...
| Compile-time System One (catalysts ≠ summaries) | [byenzyme/enzyme](https://github.com/byenzyme/enzyme) | license **null**; **63★** this pass, SIGNAL ★62; README SHA `9af7c570`. guidance ≠ hook; catalysts ≠ summaries; compile-time System One. ~350×/1000× *theirs*. `notes.md` §94 |
| Unofficial JA ModernBERT (not TypeSafe) | [argos1111/modernbert-ja-310m-jev](https://huggingface.co/argos1111/modernbert-ja-310m-jev) | CC-BY-SA-4.0; **2 likes**; sha `07cda235`. unofficial ≠ TypeSafe; format_version modernbert-jev/1; Argos1111/jev_local ≠ us/jev-local ≠ kunchenguid/local-jev. JGLUE JNLI 92.62% / JComQA 92.40% *theirs*. `notes.md` §94 |
| NAR / multimodal / Router-OOD (*theirs*) | [Nemotron_Jev](https://github.com/pst2154/Nemotron_Jev) + [djev-dev](https://github.com/Davipar/djev-dev) + [Laya essay](https://laya.convaiinnovations.com/) | Nemotron ≠ TypeSafe Jev; not a calibrated replacement. djev-dev complements djev-spark; images as Choice options. Laya essay numbers *theirs*; Router/OOD confidence. Gemma ~0.2s *theirs*. `notes.md` §94 |
