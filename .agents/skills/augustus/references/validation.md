...
| Pre-registered adversarial eval (not Harbor) | [willkelly/jev-evaluation](https://github.com/willkelly/jev-evaluation) | Python MIT; **0★**; README SHA `c6aa7e71`. adversarial pre-registered Jev eval. 28 predictions before data. 123,805 requests. confidence does not track ignorance. polite injection 65% / crude 0%. ≠ jevals ≠ jev-baselines-eval. `notes.md` §101 |
