...
| Decision-as-plugin next-act (description ≠ Score) | [jev-orchestrator](https://github.com/petercr/jev-orchestrator) | MIT **0★**; README SHA `042c102e`. difficulty + policy thresholds + JSONL trace. FINISH 0.95 / test 0.8 / askUser 0.9 *theirs* as sensors. `notes.md` §93 |
| Migration keep is a win (20-case cost gate) | [jev-replacement](https://github.com/SunnyKikiHK/jev-replacement) | license null; **0★**; README SHA `3988319e`. keep/shadow/hybrid/reject. acc 0.90→1.00 / F1 0.9028→1.0000 / p50 675.66→253.13 ms / cost 1.52× *theirs*; failed cost gate. `notes.md` §93 |
| Evidence projection (pointer, not summary) | [quarry](https://github.com/jackboykin/quarry) | MIT **0★**; README SHA `48e119fd`. quarry evidence projection. p&lt;0.5 dropped; top 3; 5 s fail-open. `notes.md` §93 |
| Injection-firewall demo (no published ASR/FPR) | [one-dollar-tahoe](https://github.com/PavitarSinghArneja/one-dollar-tahoe) | MIT **0★**; README SHA `84bf6bd2`. one-dollar-tahoe TypeSafe Jev defense eval. ~74 demo. Do not invent ASR/FPR. rh-guard owns. `notes.md` §93 |
| llama.cpp numbered-choice softmax ≠ Noul | [llama-jev](https://github.com/webNeat/llama-jev) | license null; **0★**; README SHA `5ec204af`. llama-jev llama.cpp replica. 80 ms cold / 40 ms cache *theirs*. `notes.md` §93 |
| Physical/control atlas (seed-0 ≠ rate) | [Frank-ZY-Dou/awesome-jev](https://github.com/Frank-ZY-Dou/awesome-jev) | license null; **0★**; README SHA `c4825b7f`. Frank-ZY-Dou/awesome-jev robotics/3D/control. OpenRoboto 113 cycles $0.018825 *theirs* one seed-0. `notes.md` §93 |
