...
No and no. Calibration is not alpha. NO CURRENT ALPHA CANDIDATE. ΔR² approximately +0.00084. Brier 0.2131387. ECE 0.0421875. Adding Jev probability to deterministic volatility improved Brier by only 1.4058e-05. alakise/calibration-is-not-alpha Python MIT; **0★**; HEAD `064b75f5`; size **0** WITH CONTENTS. PRIMARY. `notes.md` §111.
...
No and no. prefill plus exactly one decode. softmax over A/B/C ≠ Noul. BBQ 9,053/10,000 (90.53%). ECE 0.0890. Mean confidence 0.9943. overconfident. score and noul not implemented. siren2345/jev-single-decode Python MIT; **0★**; HEAD `fda74a09`. `notes.md` §111.
...
No, no, and no. Hub `archerhume/4rcherhume` HTTP **401**. tracker likes 64 flat, lastModified UNCHANGED. Laya likes 817 (was 802). Blackwood tracker ABSENT. Archer still promised_not_landed. Live REST pulse: SemIf 2206★ (+20 vs §110 2186); jevlike 1042★ (+4 vs 1038); TypeAR 14★ flat. AnotiaWang 97★ (+1 vs 96) ≠ yibie/awesome-jev 503★ (+13 vs 490). do not reopen or amend PR #23/#24/#25/#26/#27/#28. `invented_signal: false`. `notes.md` §111.
