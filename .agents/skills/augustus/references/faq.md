...
## Is system-one-bench mallahyari/system-one-benchmark? Treat 12 records as one leaderboard? Promote reported to reproduced?

No, no, and no. independent System One evidence catalog. scores not one leaderboard. no external record currently reproduced. TokenTrim no-Jev matched hybrid 62.4% vs best fixed 60.3% (cached answers). `npm test` checks catalog without model calls. JavaScript MIT; **0★**; HEAD `4a83bae6`; README SHA `3e7109bf`; GitHub size **0** with contents. reachjalil/system-one-bench ≠ mallahyari/system-one-benchmark. Soft Noul ≠ hard safety. `notes.md` §103.
...
No and no. parallel rank-prediction vs serial selection. independent questions can conflict. Integers −1e6..1e6. HTML; license **null**; **1★**; HEAD `2d960ab9`; README SHA `cbe5e6bf`; GitHub size **0** with contents. zzzzzec/jevsort ≠ keltokhy/jsort. `notes.md` §103.

## Is awesome-open-system-one AnotiaWang/awesome-jev? Paste von sub-15ms as an Augustus fact?

No and no. curated open System One ecosystem catalog (open models/evals/calibration/constrained-decoding), not closed-Jev apps. CC0 1.0 LICENSE SHA `36848c0b`; GitHub SPDX NOASSERTION; **0★**; HEAD `637ee3d3`; README SHA `0007e343`; GitHub size **0** with contents. rupeshpoojary9/awesome-open-system-one ≠ AnotiaWang/awesome-jev. Do not paste listed 4esv/jev-eval or von sub-15ms as Augustus receipts. `notes.md` §103.
...
No, no, and no. Hub `archerhume/4rcherhume` HTTP **401** (last pin §101; not re-fetched as a rewrite). Tracker likes **54**; lastModified `2026-09-20T02:59:13Z`. Live REST pulse (review relock): SemIf **2012★** (+12 vs §102 **2000**); jevlike **1006★** (+4 vs §102 **1002**); TypeAR-AI/TypeAR **12★** **flat**. AnotiaWang/awesome-jev **86★** **flat** ≠ Awesomejev 561/27007. `invented_signal: false`. `notes.md` §103.
