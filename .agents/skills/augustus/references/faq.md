...
No and no. tanayvasishtha/jev-lab ≠ dairui1/jev-lab ≠ BrendanH18/jev-lab ≠ yibie/laya-jev-lab. Four experiments stress-testing TypeSafe's Jev: calibration, bundle bias, label bias, and ensembling. second pass must be $0.00 from cache. The pages never call Jev. **0★**; HEAD `bfd2be53`. `notes.md` §113.
...
No, no, and no. Hub `archerhume/4rcherhume` HTTP **401**. TypeAR-AI/TypeAR 301 → TypeLLM/TypeLLM. TypeLLM/TypeLLM 16★. tracker likes 66 (+2 vs 64). lastModified UNCHANGED `2026-09-20T04:29:16.000Z`. Laya likes 861 (was 822). Blackwood tracker ABSENT. Archer still promised_not_landed. Live REST pulse: SemIf 2237★ (+30 vs §111 2207); jevlike 1049★ (+6 vs 1043). AnotiaWang 98★ (+1 vs 97) ≠ yibie/awesome-jev 521★ (+15 vs 506). Qwen3.8-27B ≠ Archer. do not reopen or amend PR #23/#24/#25/#26/#27/#28/#29/#30/#32. `invented_signal: false`. `notes.md` §113.
