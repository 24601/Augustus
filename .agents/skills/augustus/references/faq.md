...
No and no. prefill plus exactly one decode. softmax over A/B/C ≠ Noul. BBQ 9,053/10,000 (90.53%). ECE 0.0890. Mean confidence 0.9943. overconfident. score and noul not implemented. siren2345/jev-single-decode Python MIT; **0★**; HEAD `be5ed87a`. `notes.md` §111.
...
No, no, and no. Hub `archerhume/4rcherhume` HTTP **401**. tracker likes 64 flat, lastModified UNCHANGED. Laya likes 811 (was 802). Blackwood tracker ABSENT. Archer still promised_not_landed. Live REST pulse: SemIf 2198★ (+12 vs §110 2186); jevlike 1039★ (+1 vs 1038); TypeAR 14★ flat. AnotiaWang 96★ flat ≠ yibie/awesome-jev 498★ (+8 vs 490). do not reopen or amend PR #23/#24/#25/#26/#27/#28. `invented_signal: false`. `notes.md` §111.
