...
| Treat empty README as a Harbor harness / collapse JulesHuisman into SivletLabs | Scaffolding | JulesHuisman/jev-eval scaffolding / empty README SHA e69de29b. `notes.md` §109 |
...
| Treat A/B/C as Harbor / Awesomejev 656 as eval | Catalog ≠ endorsement | 947 repos scored; A 273 / B 302 / C 372. LLM rubric ≠ benches. No benchmark winner claimed. Awesomejev 656 entries / 38,160 stars. `notes.md` §109 |
